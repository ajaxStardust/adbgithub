...
require_once 'public/class/class-cwthumbs.php';
...
$caroselThumbs = $caroselObject->makeThumbs("assets/images/xsidebar", "assets/images/xsidebar");
...
<head>
    ...
    <script type="text/javascript" src="assets/js/iframestuff.js"></script>
                    ...
                    <dd class="m-4">
                        ...
                        <div id="carouselControl" class="carousel slide bg-dark" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <?php
                                $contactSheet1 = "\n";
                                $ptbThumbs = $ptbObject->makeThumbs("assets/images/ptb", "assets/images/ptb");
                                if (isset($ptbThumbs) && is_array($ptbThumbs)) {
                                    foreach ($ptbThumbs as $ptbKey => $ptbImg) {
                                        $ptbImg = "assets/images/ptb/" . $ptbImg;
                                        // $imgCounter = $imgNumber[$ptbKey];
                                        $contactSheet1 .= "<div class=\"carousel-item\"><img src=\"" . $ptbImg . "\" alt=\"" . $ptbImg . "\" title=\"" . $ptbImg . "\" /></div> \n";
                                    }
                                } else {
                                    $contactSheet1 .= '<li class="bold nobull noBull">Sorry, but there is an error in the source, specific to the image resources contact-sheet previews. <br />Specifically, the ADB PHP-class, <em>cwThumbs</em> fails the logical condition of <br /><pre>'.$ptbThumbs.'

                        does not exist, is not an array, is has not been properly set.</li>' . "\n";
                                }
                                print $contactSheet1;
                                ?>
                            </div>
                    ...
                    <dd class="m-4">
                        ...
                        <div id="carouselControl_two" class="carousel slide bg-dark" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <?php
                                $contactSheet2 = "\n";
                                $cwdThumbs = $cwdObject->makeThumbs("assets/images/cwd", "assets/images/cwd");
                                if (isset($cwdThumbs) && is_array($cwdThumbs)) {
                                    foreach ($cwdThumbs as $cwdKey => $cwdImg) {
                                        $cwdImg = "assets/images/cwd/" . $cwdImg;
                    ...
                    <dd class="m-4">
                        ...
                        <div id="carouselControl_three" class="carousel slide bg-dark" data-bs-ride="carousel">
                            <div class="carousel-inner">
                                ...
                                <?php
                                $contactSheet3 = "\n";
                                $xsThumbs = $caroselObject->makeThumbs("assets/images/xsidebar", "assets/images/xsidebar");
                                if (isset($xsThumbs) && is_array($xsThumbs)) {
                                    foreach ($xsThumbs as $xsKey => $xsImg) {
                                        $xsImg = "assets/images/xsidebar/" . $xsImg;
