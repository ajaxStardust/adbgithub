...
if(file_exists($abspath . "/class/cwthumbs.class.php")){
    require $abspath . "/class/cwthumbs.class.php";
}
else {
	$javaScriptAlert[] = '
	<script type="text/javascript">
		alert("FAIL in File: cwthumbs.INC.php\n at '.__LINE__.': It seems the file, &#x201c;'.$abspath.'&#x2f;class&#x2f;cwthumbs.CLASS.php&#x201d; unavailable.");
	</script>
	';
}
