...
<div id="pageControls">
	...
	<ul id="controList">
	<li id="toTopJscon">
			<a class="intraNav" href="#header"><img src="<?php print $xro ?>css/arrow-up.gif" alt="jump to top" /> <span id="headerJumper">top</span> </a></li>
		...
		<li id="toBottom">
			<a class="intraNav" href="#footer"><img src="<?php print $xro ?>css/arrow-down.gif" alt="jump to bottom" /> <span id="footJumper">bottom</span> 
			</a></li>
