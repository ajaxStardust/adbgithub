...
if(isset($this->bodyid)){
	...
	print '
<style>
	body#'.$this->bodyid.' li#'.$this->bodyid.'Nav a {
		/* background-color:#E1EbFF; */
		background-color:transparent;
		color:#008;
		font-weight:bold;
	}
	body#'.$this->bodyid.' li#'.$this->bodyid.'Nav {
		background-color: rgba(225, 235, 255, 0.6);
		border:0.2em solid #e1ebff;
	}
	body#'.$this->bodyid.' li#'.$this->bodyid.'Nav:hover {
		color:#000;
	}
</style>
	';
...
if(file_exists('./resources/GillSansMT-ExtraCondensedBold.ttf')){
	print '
<style type="text/css"><!--/*--><![CDATA[/*><!--*/
/* style.css.php */
