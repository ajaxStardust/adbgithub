...
<div id="pageControls" class="test1">
    ...
    <ul id="controList">
    <li id="toTopJscon">
            <a class="intraNav" href="#header"><img src="<?php echo $xro; ?>assets/css/arrow-up.png" alt="jump to top" /> <span id="headerJumper">top</span> </a></li>
        <li id="leftColtrigger" onclick="collapseNav('leftcol')">
            <span class="trigger">
                <a title="Toggle show &#x2F; hide HTML id:leftcol (the navigation at left)">
                    <img id="navControl" src="<?php echo $xro; ?>assets/css/directional-arrow-left.png" alt="collapse navigation" /> <span id="navTxt">toggle</span> nav </a></span></li>
        ...
        <li id="fbloader" class="loader">
            <span class="loader">
                <a title="Click to activate the portable Firebug Lite script embedded in my javascript container"><img src="<?php echo $xro; ?>assets/css/firebug_icon_oldver.png" alt="launch firebug lite" width="16" height="16" /> Firebug <em>Lite</em></a>
            </span>
        </li>
