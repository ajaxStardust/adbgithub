...
<img class="toggleimg" alt="toggle-italic" src="assets/css/emphasis.png" /><img id="emlight" class="toggleimg" src="assets/css/light-off.png" alt="off" /></p>
<p class="togglebold" onclick="togglebold('disp', 'fontWeight', 'bold');">
<img class="toggleimg" alt="toggle-bold" src="assets/css/strong.png" /><img id="stronglight" class="toggleimg" src="assets/css/light-off.png" alt="off" /></p>
<br />
