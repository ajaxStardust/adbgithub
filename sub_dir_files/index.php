...
if(!defined( 'ABSOLUTELOCATION' )) {
    define( 'ABSOLUTELOCATION', rtrim(dirname(__FILE__,2)));
} 
...
echo '<br><strong>ABSOLUTELOCATION</strong><br>' . ABSOLUTELOCATION;

 
// define(XRO,"../");

require ABSOLUTELOCATION.'/inc/dochead.inc.php';
require ABSOLUTELOCATION.'/inc/nav.inc.php';
?>
<div id="maincol">
                                <!--    ^   id:maincol  ^   -->
...
// BEGIN PHP REQUIRE    #pageControls
            require ABSOLUTELOCATION.'/inc/jscontrols.inc.php';
            ...
            require ABSOLUTELOCATION.'/inc/accessories.inc.php';
