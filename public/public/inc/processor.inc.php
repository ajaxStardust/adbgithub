...
if (!defined('ADBLOCTN')) {
    define('ADBLOCTN', rtrim(dirname(__FILE__),"inc"));
}
$abspath = ADBLOCTN;
$rootCss = FALSE;
...
if(!defined('CSS')) {
    if($rootCss==TRUE){
        if(file_exists($depthString.'assets/css/style.css')){
                define('CSS', $depthString.'assets/css/style.css');
                define('CSSPATH', $depthString.'assets/css/');
        }
    }
    else{
