...
class CwThumbs
{
	...
	public function __construct() {
		if (empty($dir)) {
			$this->imagesDir = ADBLOCTN.'/assets/slideshow';
			
		} elseif (!empty($dir)) {
			$this->imagesDir = (is_dir($dir.'/assets/screenshots')) ? $dir.'/assets/screenshots' : $dir;
		} else {
			$this->imagesDir = ADBLOCTN.'/assets/screenshots';
		}
