...
$nav_class_dir= ADBLOCTN . '/public/class';

if(file_exists( '../inc/alphanumarray.inc.php')){
    require '../inc/alphanumarray.inc.php';
    require '../inc/basenamecleaner.inc.php';
}
if(file_exists('public\inc\nav.inc.php')) {
    $search = 'public\inc\nav.inc.php';
}
else  {
    $search = './inc/nav.inc.php';
}
$subject = $nav_class_dir;
$replace = '';
$nav_class_dir= str_ireplace($search, $replace, $subject);
$server_name = isset($_SERVER['SERVER_NAME']) ? $_SERVER['SERVER_NAME'] : ADBLOCTN;
$server_addr = isset($_SERVER['SERVER_ADDR']) ? $_SERVER['SERVER_ADDR'] : ADBLOCTN;
...
/*                      else{
            ...
            // POPULATE THE ELUSIVE ALPHANUMARRY
                    ...
                    require 'public/inc/arrayobjectparser.inc.php';


                } //    ENDIF- LARGEST CONTAINER CLOSED HERE

            require 'public/inc/arrayobjectanchors.inc.php';
