...
require $xro.'public/inc/backlinks.inc.php';
...
?>
	...
	<div class="vertMid">						<!--	^	.vertMid	^	-->
		...
		<p id="searchrec">Search privately: <a 
			...
			title="Search privately">Duck-Duck-Go for it!</a> </p><object id="duckduckgo" class="transparentback" title="Search at DuckDuckGo.com" data="assets/css/duckduckgo-icon.svg" type="image/svg+xml" height="32" width="32">
</object>
